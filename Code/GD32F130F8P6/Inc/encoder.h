...
/* GPIO Define */
/* encoder CLK Pin 脉冲 */
#define ENCODER_CLK_PIN                     GPIO_PIN_7
#define ENCODER_CLK_GPIO_PORT               GPIOA
#define ENCODER_CLK_GPIO_CLK                RCU_GPIOA
#define ENCODER_CLK_EXTI_LINE               EXTI_7
#define ENCODER_CLK_EXTI_PORT_SOURCE        EXTI_SOURCE_GPIOA
#define ENCODER_CLK_EXTI_PIN_SOURCE         EXTI_SOURCE_PIN7
#define ENCODER_CLK_EXTI_IRQn               EXTI4_15_IRQn

/* encoder DT Pin 方向 */
#define ENCODER_DT_PIN                     GPIO_PIN_1
#define ENCODER_DT_GPIO_PORT               GPIOB
#define ENCODER_DT_GPIO_CLK                RCU_GPIOB
#define ENCODER_DT_EXTI_LINE               EXTI_1
#define ENCODER_DT_EXTI_PORT_SOURCE        EXTI_SOURCE_GPIOB
...
#define ENCODER_SW_EXTI_LINE               EXTI_4
#define ENCODER_SW_EXTI_PORT_SOURCE        EXTI_SOURCE_GPIOA
#define ENCODER_SW_EXTI_PIN_SOURCE         EXTI_SOURCE_PIN4
...
typedef struct
{
    uint32_t            sw_down_time; /* >100ms 为单击，> 900为长按 */
    ...
    bool                is_rotate_flag; /* 是否发生旋转标志，不在意方向 */

    bool                sw_down_500ms_1000ms_flag;
    ec11_return_result  return_reslut;
} EC11_t;
